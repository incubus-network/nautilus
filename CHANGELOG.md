...
* (types) [tharsis#503](https://github.com/cosmos/ethermint/pull/503) The `types.DenomDefault` constant for `"avblack"` has been renamed to `types.AttovBlack`.
...
* (types) [tharsis#434](https://github.com/cosmos/ethermint/issues/434) Update default denomination to Atto vBlack (`avblack`).
...
* (types) [tharsis#507](https://github.com/cosmos/ethermint/pull/507) Fix hardcoded `avblack` on `EthAccount` balance getter and setter.
