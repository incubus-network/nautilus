...
* (analytics) [tharsis#1106](https://github.com/evmos/ethermint/pull/1106) Update telemetry to Fury modules.
...
* (feemarket) [tharsis#1026](https://github.com/evmos/ethermint/pull/1026) Fix REST endpoints to use `/fury/feemarket/*` instead of `/feemarket/evm/*`.
...
* (proto) [tharsis#448](https://github.com/evmos/ethermint/pull/448) Bump version for all Fury messages to `v1`
