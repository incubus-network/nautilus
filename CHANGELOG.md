...
* (feemarket) [tharsis#1105](https://github.com/incubus-network/ethermint/pull/1105) Update `BaseFee` calculation based on `GasWanted` instead of `GasUsed`.
...
* (feemarket) [tharsis#1026](https://github.com/incubus-network/ethermint/pull/1026) Fix REST endpoints to use `/fury/feemarket/*` instead of `/feemarket/evm/*`.
