...
// source: fury/feemarket/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fury.feemarket.v1.GenesisState")
}

func init() {
	proto.RegisterFile("fury/feemarket/v1/genesis.proto", fileDescriptor_6241c21661288629)
}
