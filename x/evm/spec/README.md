...
The `x/evm` is part of the [fury library](https://pkg.go.dev/github.com/incubus-network/fury). For an example of how Fury can be used on any Cosmos-SDK chain, please refer to [Evmos](https://www.github.com/tharsis/evmos).
