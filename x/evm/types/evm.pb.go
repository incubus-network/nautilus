...
func init() {
	proto.RegisterType((*Params)(nil), "fury.evm.v1.Params")
	proto.RegisterType((*ChainConfig)(nil), "fury.evm.v1.ChainConfig")
	proto.RegisterType((*State)(nil), "fury.evm.v1.State")
	proto.RegisterType((*TransactionLogs)(nil), "fury.evm.v1.TransactionLogs")
	proto.RegisterType((*Log)(nil), "fury.evm.v1.Log")
	proto.RegisterType((*TxResult)(nil), "fury.evm.v1.TxResult")
	proto.RegisterType((*AccessTuple)(nil), "fury.evm.v1.AccessTuple")
	proto.RegisterType((*TraceConfig)(nil), "fury.evm.v1.TraceConfig")
}

func init() { proto.RegisterFile("fury/evm/v1/evm.proto", fileDescriptor_d21ecc92c8c8583e) }
