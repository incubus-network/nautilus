...
func init() {
	proto.RegisterType((*MsgEthereumTx)(nil), "fury.evm.v1.MsgEthereumTx")
	proto.RegisterType((*LegacyTx)(nil), "fury.evm.v1.LegacyTx")
	proto.RegisterType((*AccessListTx)(nil), "fury.evm.v1.AccessListTx")
	proto.RegisterType((*DynamicFeeTx)(nil), "fury.evm.v1.DynamicFeeTx")
	proto.RegisterType((*ExtensionOptionsEthereumTx)(nil), "fury.evm.v1.ExtensionOptionsEthereumTx")
	proto.RegisterType((*MsgEthereumTxResponse)(nil), "fury.evm.v1.MsgEthereumTxResponse")
}

func init() { proto.RegisterFile("fury/evm/v1/tx.proto", fileDescriptor_f75ac0a12d075f21) }
...
func (c *msgClient) EthereumTx(ctx context.Context, in *MsgEthereumTx, opts ...grpc.CallOption) (*MsgEthereumTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fury.evm.v1.Msg/EthereumTx", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_EthereumTx_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fury.evm.v1.Msg/EthereumTx",
	}
