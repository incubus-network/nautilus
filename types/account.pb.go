...
// source: fury/types/v1/account.proto
...
func init() {
	proto.RegisterType((*EthAccount)(nil), "fury.types.v1.EthAccount")
}

func init() { proto.RegisterFile("fury/types/v1/account.proto", fileDescriptor_4edc057d42a619ef) }
