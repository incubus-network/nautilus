...
// source: fury/types/v1/indexer.proto
...
func init() {
	proto.RegisterType((*TxResult)(nil), "fury.types.v1.TxResult")
}

func init() { proto.RegisterFile("fury/types/v1/indexer.proto", fileDescriptor_1197e10a8be8ed28) }
