...
// transactions. There should only be a single implementation in Fury. For
// the purposes of Fury, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Fury will distribute the fees out to validators, so the structure
