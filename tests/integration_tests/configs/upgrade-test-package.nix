let
  pkgs = import ../../../nix { };
  fetchEthermint = rev: builtins.fetchTarball "https://github.com/incubus-network/ethermint/archive/${rev}.tar.gz";
  released = pkgs.buildGo118Module rec {
    name = "fury";
    # the commit before https://github.com/incubus-network/ethermint/pull/943
