...
def test_native_tx_priority(ethermint: Ethermint):
    ...
    test_cases = [
        {
            ...
            "amount": "1000avblack",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 600000}avblack",
        ...
        },
        {
            ...
            "amount": "1000avblack",
            "gas_prices": f"{base_fee + PRIORITY_REDUCTION * 400000}avblack",
    ...
    for tc in test_cases:
        ...
        gas_price = int(tc["gas_prices"].removesuffix("avblack"))
